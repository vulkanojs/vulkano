...
module.exports = {
  'post login': (req, res) => {                 // POST /api/auth/login
  ...
  'post logout': (req, res) => {                 // POST /api/auth/logout
    res.clearCookie('token');
    res.vsr(Promise.resolve({}));
  },
  current(req, res) {                            // GET /api/auth/current — no verb prefix needed, GET is default
